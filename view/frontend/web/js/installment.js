define(["jquery", 'Magento_Catalog/js/price-utils', 'mage/translate', 'Magento_Customer/js/customer-data'], function ($, priceUtils, $t, customerData) {
    'use strict';
    $.widget('mage.installment', {
        ...
        getElmPrice: function (elm) {
            let price = 0;
            price = ($(elm).find('.price-wrapper[data-price-type="finalPrice"]').length > 0) ? parseFloat($(elm).find('.price-wrapper[data-price-type="finalPrice"]').attr('data-price-amount')) : 0;
